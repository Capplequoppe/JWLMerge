namespace JWLMergeCore.BackupFileServices.Helpers
{
    ...
    public class BibleNotesFile
    {
        ...
        private void ParseNotes(IEnumerable<string> lines)
        {
            ...
            foreach (var line in lines)
            {
                ...
                else
                {
                    ...
                    if (currentVerseSpec != null) StoreNote(linesInNote, currentVerseSpec);
